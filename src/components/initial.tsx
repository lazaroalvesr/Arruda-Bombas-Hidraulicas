...
export const IntialPage = () => {
    return (
        <section className="w-full bg-[#F2F3F5]">
            <div className="lg:max-w-[1175px] ml-5 lg:ml-auto m-auto flex pt-[58px] items-center justify-between pb-12">
                <div className="lg:w-[580px] w-[340px] h-[360px]">
                    ...
                    <div className="pt-[30px] flex lg:gap-5 gap-4  h-[90px]">
                        <Link href="#contato">
                            <button className="bg-[#001659] text-white rounded-[16px] w-[160px] text-[15px] lg:w-[223px] lg:text-[20px] border border-transparent py-4 ">
                                Fazer Orçamento
                            </button>
                        </Link>
                        <Link
                            ...
                            target="_blank"
                            download>
                            <button className="border-[#001659] border text-[#001659] w-[160px] text-[15px] lg:text-[20px] lg:w-[223px] duration-300 ease-in-out py-4 rounded-[16px]">
                                Baixar Catálogo
                            </button>
                        </Link>
