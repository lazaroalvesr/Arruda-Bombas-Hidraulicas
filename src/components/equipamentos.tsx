    ...
    return (
        <section className="max-w-[1444px] flex m-auto items-center justify-center lg:my-[120px] my-[60px]" id="equipamento">
            <div className="flex flex-col items-center ">
                ...
                <div className="flex pt-[52px] lg:w-[1200px] lg:gap-y-8 md:w-[800px] justify-center md:gap-[20px] md:flex-wrap lg:flex-row lg:gap-[21px] flex-col md:flex-row gap-y-8 lg:gap-y-0">
                    <CardEquipamentos
